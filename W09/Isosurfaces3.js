function Isosurfaces( volume, isovalue )
{
    ...
    {
        var s0 = volume.values[v0.x + v0.y * volume.numberOfNodesPerLine() + v0.z * volume.numberOfNodesPerSlice()];
        var s1 = volume.values[v1.x + v1.y * volume.numberOfNodesPerLine() + v1.z * volume.numberOfNodesPerSlice()];
        var t = (s - s0) / (s1 - s0);
