function main()
{
    ...
    function setup()
    {
        ...
        streamline.setIntegrationStepLength( 0.5 );//interval integral
        streamline.setIntegrationTime( 500 );//numofintegral
        streamline.setIntegrationMethod( KVS.RungeKutta4 );
        streamline.setIntegrationDirection( KVS.ForwardDirection );//backforawrd
