function main()
{
    ...
    geometry.faces[1].color = new THREE.Color( 0.5, 0, 0 );
    ...
    geometry.faces[5].color = new THREE.Color( 0.5, 0, 0 );
    ...
    geometry.faces[9].color = new THREE.Color( 0.5, 0, 0 );
    geometry.faces[10].color = new THREE.Color( 1, 1, 1 );
    geometry.faces[11].color = new THREE.Color( 0.5, 0, 0 );
